...
import com.gunshop.bean.util.JsfUtil;
import com.gunshop.bean.util.PaginationHelper;
...
public class VentaController implements Serializable {
    ...
    @EJB
    private com.gunshop.bean.VentaFacade ejbFacade;
    ...
    public String create() {
        try {
            System.out.println("1: " + current.getCodUsuario());
            System.out.println("2: " + current.getSerieArma());
    ...
    public static class VentaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Venta) {
                ...
                return getStringKey(o.getCodRegistro());
            } else {
