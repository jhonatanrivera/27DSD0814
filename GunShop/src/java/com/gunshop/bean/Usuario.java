...
@NamedQueries({
    ...
    @NamedQuery(name = "Usuario.findByFeNacimiento", query = "SELECT u FROM Usuario u WHERE u.feNacimiento = :feNacimiento"),
    ...
    @NamedQuery(name = "Usuario.findByFeRegistro", query = "SELECT u FROM Usuario u WHERE u.feRegistro = :feRegistro")})
...
*/
    ...
    public String toString() {
        return "com.gunshop.bean.Usuario[ codUsuario=" + codUsuario + " ]";
    }
